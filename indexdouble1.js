...
(async () => {
  ...
  for(i=0;i<10000;i++){
    ...
    if(ultimodouble > 7){
      if(contador3 > margem && (i % 5) == 0 && ultimodouble != 0){
    ...
    }else if(ultimodouble == 0 && contador1 > 0){
      if(contador3 > margem && (i % 5) == 0 && ultimodouble != 0){
        await page.evaluate(() => {return document.querySelector('div.red').click()});
        contador2 = 2;
      }else{
    ...
    }else if(ultimodouble == 0 && contador2 > 0){
      if(contador3 > margem && (i % 5) == 0 && ultimodouble != 0){
        await page.evaluate(() => {return document.querySelector('div.black').click()});
        contador1 = 2;
      }else{
    ...
    console.log(`Total acertos: ${contador4}. Total erros: ${contador5}. Máximo de erros consecutivos: ${contador6}`);
